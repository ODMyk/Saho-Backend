...
namespace Infrastructure.SQL.Migrations
{
    ...
    [Migration("20240302173241_Migration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.SQL.Entities.PlaylistEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Infrastructure.SQL.Entities.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FavoriteAlbum", b =>
                {
                    ...
                    b.HasOne("Infrastructure.SQL.Entities.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FavoritePlaylist", b =>
                {
                    b.HasOne("Infrastructure.SQL.Entities.PlaylistEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Infrastructure.SQL.Entities.PlaylistEntity", b =>
                {
                    b.HasOne("Infrastructure.SQL.Entities.UserEntity", "Owner")
                        .WithMany("Playlists")
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasOne("Infrastructure.SQL.Entities.RoleEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
